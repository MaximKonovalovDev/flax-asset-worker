...
# ---------------------------------------------------------------------------
# Quixel scanner moved to providers/quixel_scanner.py (Path B s3 2026-05-10).
# Re-exported here for backward-compat so existing importers don't break.
# New code should import from `assetboy.providers.quixel_scanner` directly.
# ---------------------------------------------------------------------------
from assetboy.providers.quixel_scanner import (  # noqa: F401  (backward-compat re-exports)
